...
xroar -c $HOME/.xroar/xroar.conf -default-machine coco3h -ram 2048K -machine-cpu 6309 -tv-input rgb -machine-cart ide -load-hd0 $HOME/source/eou_ide/build/6309_ide_xroar/63IDE.ide -load-hd1 /media/share1/EMU/EOU/EOU_USER.VHD -type '\r\DOS\r' $XROARPARMS
