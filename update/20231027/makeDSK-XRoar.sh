...
# System to use for XRoar (i.e. coco2 coco2b, coco2bus, coco2bhus, coco3, coco3h) and use pyDriveWire (yes or no)
...
if [[ $2 =~ Y|y ]];then
	...
	if [[ $1 =~ coco2|coco2b|coco2bus|coco2bhus ]];then
...
if [[ $1 =~ coco3|coco3h ]];then
	...
	echo -e
	echo -e "coco2, coco2b, coco2bus, coco2bhus, coco3, coco3h"
...
if [[ $1 =~ coco2|coco2b|coco2bus|coco2bhus|coco3|coco3h ]];then
