...
then
    ...
    # disable Becker port
    cp $HOME/.mame/cfg/deluxecoco.cfg.beckerport-disabled $HOME/.mame/cfg/deluxecoco.cfg
...
then
	...
	mame deluxecoco -ramsize 64k -flop1 "$floppy" $MAMEPARMS
    ...
    mame deluxecoco -ramsize 64k -flop1 "$1" $MAMEPARMS
